...
def build_async_client(base_url: str | None, api_key: str | None) -> AsyncOpenAI:
    return AsyncOpenAI(
...
async def translate_abstract_async(client: AsyncOpenAI, model: str, abstract_en: str) -> str:
    system = "你是学术翻译助手，输出简体中文，忠实准确，风格正式。"
    user = (
        "请将下面英文摘要翻译为简体中文。\n"
        "规则：\n"
